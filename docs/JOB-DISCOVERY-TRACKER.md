...
- [ ] **`REC-14` [UX] "Top Picks" Hero Carousel & Visual Hierarchy**
  ...
  - **Target Files**: `src/components/discovery/DiscoveryPage.tsx`, `src/components/discovery/DiscoveryJobRow.tsx`
  - **Status**: `Pending`
  - **Completed At**: —
