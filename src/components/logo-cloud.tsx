...
export function LogoCloud() {
	return (
		<div className="grid grid-cols-2 border-x md:grid-cols-4">
			<LogoCard
				className="relative border-r border-b bg-secondary dark:bg-secondary/30"
				logo={{ src: "https://storage.efferd.com/logo/nvidia-wordmark.svg", alt: "Nvidia Logo" }}
			>
			...
			<LogoCard
				...
				logo={{ src: "https://storage.efferd.com/logo/supabase-wordmark.svg", alt: "Supabase Logo" }}
			/>

			<LogoCard
				className="relative border-r border-b md:bg-secondary dark:md:bg-secondary/30"
				logo={{ src: "https://storage.efferd.com/logo/github-wordmark.svg", alt: "GitHub Logo" }}
			>
				<DecorIcon className="z-10" position="bottom-right" />
			...
			<LogoCard
				...
				logo={{ src: "https://storage.efferd.com/logo/openai-wordmark.svg", alt: "OpenAI Logo" }}
			/>
			...
			<LogoCard
				...
				logo={{ src: "https://storage.efferd.com/logo/turso-wordmark.svg", alt: "Turso Logo" }}
			>
			...
			<LogoCard
				...
				logo={{ src: "https://storage.efferd.com/logo/clerk-wordmark.svg", alt: "Clerk Logo" }}
			/>

			<LogoCard
				className="border-r"
				logo={{ src: "https://storage.efferd.com/logo/claude-wordmark.svg", alt: "Claude AI Logo" }}
			/>

			<LogoCard
				className="bg-secondary dark:bg-secondary/30"
				logo={{ src: "https://storage.efferd.com/logo/vercel-wordmark.svg", alt: "Vercel Logo" }}
			/>
		</div>
	);
}
