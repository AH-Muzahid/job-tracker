    ...
    <div className="flex h-full w-full overflow-hidden bg-background">
      ...
      <div className="flex-1 flex flex-col h-full min-w-0 bg-background overflow-hidden relative">
        ...
        >
          {!loading && !hasMessages ? (
            isSidebar ? (
              /* Compact Sidebar Starter View (Single Column, No Horizontal Squish) */
              <div className="flex flex-col justify-between min-h-full p-3.5 sm:p-4">
                <div className="space-y-3.5 my-auto py-2">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed font-normal">
                      Scan job descriptions, tailor cover letters, practice interview questions, or update your applications.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col gap-2 pt-1">
                    {STARTER_PROMPTS.map((item) => (
                      <button
                        ...
                        className="flex items-start gap-2.5 p-2.5 rounded-[6px] border border-border bg-card/60 hover:bg-muted/60 transition-colors text-left group cursor-pointer"
                      >
                        <div className="p-1 rounded-sm bg-muted text-muted-foreground group-hover:text-foreground shrink-0 mt-0.5">
                        ...
                        <div className="flex flex-col min-w-0">
                          ...
                          <span className="text-[11px] text-muted-foreground line-clamp-1 mt-0.5 leading-normal">
                            {item.description}
                          </span>
                        </div>
                      </button>
              ...
              /* Fullscreen Spacious Starter View */
                ...
                <div className="w-full max-w-2xl space-y-6 my-auto">
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground max-w-md mx-auto leading-relaxed">
                      Your autonomous career accelerator. Analyze job matches, draft outreach, prepare for interviews, and manage your pipeline.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full">
                    {STARTER_PROMPTS.map((item) => (
                      <button
                        ...
                        className="flex items-start gap-3 p-3.5 rounded-[6px] border border-border bg-card/60 hover:bg-muted/60 transition-colors text-left group cursor-pointer"
                      >
                        <div className="p-1.5 rounded-sm bg-muted text-muted-foreground group-hover:text-foreground shrink-0 mt-0.5">
              ...
              {error && (
                <div className="flex items-center justify-between gap-2 text-xs font-medium text-destructive p-3 rounded-sm bg-destructive/10 border border-destructive/20">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() => handleRetry()}
                    className="h-6 text-xs px-2 bg-background hover:bg-muted border-destructive/30 text-destructive shrink-0 cursor-pointer"
                  >
      ...
      {/* Workspace Drawer (slides in from right in fullscreen view) */}
